...
| Step | Action |
|------|--------|
| **①** | Get the compiled AutoML pipeline from [automl repository](https://github.com/red-hat-data-services/red-hat-ai-examples/tree/main/examples/automl/pipeline.yaml).
